...
-- 			D = {":lua vim.lsp.buf.definition()<CR>", "Declaration" },
...
local nmappings_leader = {
  ...
  ["et"] = { "<cmd>wqa<CR>", "Close vim and save all" },
  ...
  ["f"] = {
	...
	F = { "<cmd>lua require('telescope.builtin').git_files(require('telescope.themes').get_dropdown{previewer = false})<cr>", "Files", },
  -- ["F"] = { "<cmd>Telescope live_grep theme=ivy<cr>", "Find File (git)" },
  ...
  p = {
	...
	g = {
			...
			r = {":lua vim.lsp.buf.references()<CR>", "References" },
			t = {":lua vim.lsp.buf.type_definition()<CR>", "Type Definition" },
			e = {":lua vim.diagnostic.open_float()<CR>", "Diagnostic message"}
	},

	K = {":lua vim.lsp.buf.hover()<CR>", "Hover" },
	-- ["<c-k>"] = {":lua vim.lsp.buf.signature_help()<CR>", "Signature Help"},
	["rr"] = {":lua vim.lsp.buf.code_action()<CR>", "Code Action"},
...
whichkey.register(nmappings_leader, nopts_leader);
