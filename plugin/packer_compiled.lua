...
_G.packer_plugins = {
  ...
  ["leap.nvim"] = {
    loaded = true,
    path = "/home/jonathan/.local/share/nvim/site/pack/packer/start/leap.nvim",
  ...
  neon = {
    loaded = true,
    path = "/home/jonathan/.local/share/nvim/site/pack/packer/start/neon",
  ...
  ["nvim-ts-rainbow"] = {
    ...
    loaded = true,
    path = "/home/jonathan/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow",
  ...
  ["onedark.vim"] = {
    loaded = true,
    path = "/home/jonathan/.local/share/nvim/site/pack/packer/start/onedark.vim",
  ...
  ["vim-code-dark"] = {
    loaded = true,
    path = "/home/jonathan/.local/share/nvim/site/pack/packer/start/vim-code-dark",
    url = "https://github.com/tomasiser/vim-code-dark"
  },
  ["vim-commentary"] = {
    loaded = true,
    path = "/home/jonathan/.local/share/nvim/site/pack/packer/start/vim-commentary",
